...
const SiteHeader = () => {
  ...
  return (
    <header className="fixed inset-x-0 top-0 z-50 border-b border-white/10 bg-hero/85 backdrop-blur-xl">
      <div className="mx-auto flex h-16 max-w-7xl items-center justify-between px-6 lg:px-10">
        <Link to="/" className="font-display text-xl text-hero-foreground" aria-label="Eniolami Saheed home"><span className="sm:hidden">ES<span className="text-stat-accent">.</span></span><span className="hidden sm:inline">Eniolami Saheed<span className="text-stat-accent">.</span></span></Link>
        <nav className="hidden items-center gap-7 lg:flex" aria-label="Primary navigation">
          ...
          <Link to="/contact" className="rounded-full bg-accent px-5 py-2.5 text-sm font-bold text-accent-foreground transition-transform duration-300 hover:-translate-y-1">Let&apos;s talk</Link>
        </nav>
